...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <section id="loginForm">
        ...
        <asp:Login runat="server" ViewStateMode="Disabled" RenderOuterTable="false" ID="login1">
            <LayoutTemplate>
                ...
                <fieldset>
                    ...
                    <asp:Button runat="server" CommandName="Login" Text="Iniciar sesión" ID="loginButton" OnClick="loginButton_Click"/>
                </fieldset>
            </LayoutTemplate>
        </asp:Login>
        <p>
